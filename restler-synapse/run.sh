...
case "$1" in
  compile)
    ...
    docker run --rm \
        ...
        -w /work \
        restler \
        /RESTler/restler/Restler compile /work/config.json
    ;;
  ...
  fuzz)
    ...
    docker run --rm \
      ...
      -w /work \
      restler \
      /RESTler/restler/Restler fuzz --grammar_file /work/Compile/grammar.py --dictionary_file /work/Compile/dict.json --settings /work/Compile/engine_settings.json --no_ssl --time_budget 10
    ;;
  *)
